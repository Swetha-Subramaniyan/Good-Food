...
CREATE TABLE `User_Address` (
    ...
    UNIQUE INDEX `User_Address_customer_id_key`(`customer_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `User_Subscription` (
    ...
    UNIQUE INDEX `User_Subscription_customer_id_key`(`customer_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Subscription_Order` (
    ...
    UNIQUE INDEX `Subscription_Order_customer_id_key`(`customer_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `User_Subscription` ADD CONSTRAINT `User_Subscription_customer_id_fkey` FOREIGN KEY (`customer_id`) REFERENCES `User_Address`(`customer_id`) ON DELETE RESTRICT ON UPDATE CASCADE;
