  ...
  useEffect(() => {
    const fetchPlans = async () => {
      try {
        ...
        const budgetPlans = response.data.formattedSubscriptions["Individual Plan"]["Elite"].filter(
          (plan) => plan.meal_type === "Lunch"
        );
  ...
  return (
    <>
      <div className='backgrd'>
        ...
        {/* Display available Breakfast Budget plans below the Subscribe button */}
