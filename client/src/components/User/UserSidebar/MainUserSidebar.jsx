...
//       navigate('/admin/subscriptionmenulist')
//     }else if (menuItem==='Subscribed Users'){
//       navigate('/admin/subscribedusers')
//     }
...
//           <Divider />
//           <List>
//             {['Profile', 'Notification', 'Subscription', 'Cart', 'Wallet', 'Order',  'Log Out', 'Admin'].map((text, index) => (
